/**
 * Author: maspy
 * Source: https://github.com/maspypy/library/blob/main/ds/offline_query/mo_3d.hpp
 * Description: MO supporting modifications (query value in time t on [l, r])
 * Time: O(N ** (5/3)) for N \tilde Q
 */
#pragma once
